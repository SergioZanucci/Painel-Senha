class Cliente {
  ...
  function mostrarMensagem(cliente, cpf, cnpj) {
    if (cpf == cliente.cpf) {
      btnConfirma = document.querySelector(".nome__cliente");
      btnConfirma.innerHTML = `Seja bem-vindo cooperado, ${cliente.nome}!`;
    } else if (cnpj == cliente.cnpj) {
      btnConfirma = document.querySelector(".nome__cliente");
      btnConfirma.innerHTML = `Seja bem-vindo cooperado, ${cliente.nome}!`;
    } else {
      btnConfirma = document.querySelector(".nome__cliente");
      btnConfirma.innerHTML = `Seja bem vindo!`;
    }
  }
